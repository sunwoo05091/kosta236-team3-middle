...
<ul class="nav nav-pills flex-column">
	...
	<li><a href="listAction.do"><button type="button" class="btn btn-outline-primary">전체 조회</button></a></li><br>
	<li></li>
	<li><a href="TypeScheduleAction.do?s_type=1">개인</a></li>
	<li><a href="TypeScheduleAction.do?s_type=2">미팅</a></li>
	<li><a href="TypeScheduleAction.do?s_type=3">회의</a></li>
</ul>
<div class="card-header">오늘 일정</div>
<c:forEach var="schedule" items="${schedule }">
<div class="card text-white bg-primary mb-3" style="font-size:10px; width: 300px; height: 100px;">
  <div class="card-body">
