...
<form action="insertAction.do" method="post">
	...
	기간 : <input type="date" name="s_startday" style=" border-radius: 10px; border-color:#d2d2d2;"> ~ <input type="date" name="s_finishday" style=" border-radius: 10px;border-color:#d2d2d2;"><br><br>
