...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Data</li>
	...
	<h2>글세부보기</h2>
	<ul>
		<li>${community.cm_no }</li>
		<li>${community.cm_title }</li>
		<li>${community.cm_price }</li>
		<li>${community.cm_contents }</li>
	</ul>
	...
	<form action="insertReplyAction.do" method="post">
		...
		댓글 내용 : <input type="text" name="cm_r_contents"><br>
		<input type="submit" value="댓글쓰기"> 
	</form>
	<c:if test="${emp.emp_no }">
