...
<ul class="nav nav-pills flex-column">
    ...
    <li class="nav-item">
        <a class="nav-link active" href="${sessionScope.contextPath}/mypage/attendance.do">근태 기록</a>
    </li>
    <li class="nav-item">
...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="${sessionScope.contextPath}/mypage/attendance.do">근태 기록</a></li>
</ol>
    ...
    <ul class="pagination">
        <c:if test="${listAttendance.startPage >= 6}">
            <li class="page-item disabled">
                <a class="page-link" href="attendance.do?pageNum=${listAttendance.startPage - 1}">&laquo;</a>
            </li>
        </c:if>
            ...
            <c:choose>
                <c:when test="${listAttendance.requestPage == pageNo}">
                    <li class="page-item active">
                        <a class="page-link" href="attendance.do?pageNum=${pageNo}">${pageNo}</a>
                    </li>
                </c:when>
                <c:otherwise>
                    <li class="page-item">
        ...
        <c:if test="${listAttendance.endPage < listAttendance.totalPageCount}">
            <li class="page-item">
                <a class="page-link" href="attendance.do?pageNum=${listAttendance.endPage + 1}">&raquo;</a>
            </li>
        </c:if>
    </ul>
</div>
