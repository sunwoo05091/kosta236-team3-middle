...
<table class="table table-bordered">
  ...
  <ul class="pagination">
	...
	<c:if test="${documentList.startPage >= 6 }">
	    <li class="page-item">
		<a class="page-link" href="listDocumentSignProgressAction.do?pageNum=${documentList.startPage - 1 }">[이전]</a>
		</li>
	</c:if>
	...
	<c:forEach var="pageNo" begin="${documentList.startPage }" end="${documentList.endPage }">
		...
		<li class="page-item">
		<a class="page-link" href="listDocumentSignProgressAction.do?pageNum=${pageNo }">[${pageNo }]</a>
		</li>
		<c:if test="${documentList.requestPage == pageNo }"></c:if>
	</c:forEach>
	...
	<c:if test="${documentList.endPage < documentList.totalPageCount }">
		 <li class="page-item">
		<a class="page-link" href="listDocumentSignProgressAction.do?pageNum=${documentList.endPage + 1 }">[이후]</a>
		</li>
	</c:if>
	</li>
	</ul>
...
<form action="listDocumentSignProgressAction.do" method="get">
